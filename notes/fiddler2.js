...
class Handlers
{
    ...
    */
    ...
    RulesStringValue(14,"IE 11 (Win8.1)", "Mozilla/5.0 (IE 11.0; Windows NT 6.3; WOW64; Trident/7.0; rv:11.0) like Gecko")
    ...
    RulesStringValue(17,"&Firefox 21", "Mozilla/5.0 (Windows NT 6.2; WOW64; rv:21.0) Gecko/20100101 Firefox/21.0")
    RulesStringValue(18,"&Firefox Phone", "User-Agent: Mozilla/5.0 (Mobile; rv:18.0) Gecko/18.0 Firefox/18.0")
    RulesStringValue(19,"&Firefox (Mac)", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10.8; rv:19.0) Gecko/20100101 Firefox/19.0")
    RulesStringValue(20,"Chrome (Win8)", "Mozilla/5.0 (Windows NT 6.2; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/27.0.1453.93 Safari/537.36")
    ...
    static function OnBeforeRequest(oSession: Session) {
        ...
        // }
        // 
        if(oSession.uriContains("pe/1.html")){
